...
public class TimeCalculator extends JFrame {
    ...
    private void addLiveUpdate(JTextField f) {
        f.getDocument().addDocumentListener(new DocumentListener() {
            public void insertUpdate(DocumentEvent e) { calculateResult(); }
            public void removeUpdate(DocumentEvent e) { calculateResult(); }
            public void changedUpdate(DocumentEvent e) { calculateResult(); }
        });
    }
    ...
    private void updateStopButtonState() {
        boolean running = countdownTimer.isRunning();
        if (running) {
    ...
    /* --------------------------------------------------------------
       CORE: calculateResult() — Always updates UI
       -------------------------------------------------------------- */
